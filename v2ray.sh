...
install_v2ray() {
	...
	if [[ $local_install ]]; then
		...
		mkdir /tmp/v2ray-d/ && mkdir /tmp/v2ray/ && mkdir -p /etc/v2ray/233boy/v2ray/
        git clone https://github.com/leekunha/233boy_v2ray/ /tmp/v2ray-d/
		chmod 755 /tmp/v2ray-d/v2ray-3.05.zip
		unzip /tmp/v2ray-d/v2ray-3.05.zip -d /tmp/v2ray/
		cp -rf /tmp/v2ray/v2ray-3.05/* /etc/v2ray/233boy/v2ray
		popd
